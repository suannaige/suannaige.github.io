...
## 专业技能
- **编程语言:** 熟练掌握 Python 及 C++，具备扎实的算法与数据结构基础。
- **深度学习:** 精通 PyTorch 框架，能够独立完成从模型设计、高效训练到性能优化的全流程。
- **大模型技术:** 深入理解 LLM/MLLM 主流架构（如 Qwen-VL），具备丰富的 LoRA 微调、指令微调、量化及高效推理部署经验。
- **多模态技术:** 掌握跨模态表征学习与特征融合核心方法，具备设计与实现端到端多模态系统的能力。
- **工程与开发:** 熟悉 Docker、Git 等协作工具；能够利用 ComfyUI 等 AIGC 工具链进行快速原型验证与系统集成。
